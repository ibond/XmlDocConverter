...
namespace XmlDocConverter.Fluent
{
	...
	public static class StandardDocumentSources
	{
		...
		public static EmitContext<RootContext> From<DocumentContextType>(this EmitContext<DocumentContextType> context, string assemblyPath)
		...
		/// <returns>A new context with the updated assembly.</returns>
		public static EmitContext<RootContext> From<DocumentContextType>(this EmitContext<DocumentContextType> context, string assemblyPath, string xmlDocPath)
			where DocumentContextType : DocumentContext
		{
		...
		public static EmitContext<RootContext> From<DocumentContextType>(this EmitContext<DocumentContextType> context, IEnumerable<string> assemblyPaths)
			where DocumentContextType : DocumentContext
		{
		...
		/// <returns>A new context with the updated assemblies.</returns>
		public static EmitContext<RootContext> From<DocumentContextType>(this EmitContext<DocumentContextType> context, IEnumerable<XmlDocPathPair> pathPairs)
			where DocumentContextType : DocumentContext
		{
			...
			return new EmitContext<RootContext>(new RootContext(new DocumentSource(assemblyMembers)));
		}
	}
}
